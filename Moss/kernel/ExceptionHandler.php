...
class ExceptionHandler {
	...
	public function handlerVerbose($e) {
		...
		<head>
			...
			<style>
				...
				td:nth-child(1) { width: 3em; padding: 0 0.5em 0 0; text-align: right; color: #999; border-right: 1px solid #999; }
				td:nth-child(2) { padding: 0 0 0 0.5em; }

				td, td span { white-space: nowrap; }
				td span.mark { font-weight: bold; color: #f00; }
			</style>
		</head>
		<body>
	...
	protected function lineNum($source, $mark = null) {
		...
		return sprintf('<table><td>%s</td><td>%s</td></table>', implode($this->br, $lines), $source);
	}
